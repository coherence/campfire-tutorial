...
namespace Coherence.Generated
{
    ...
    public struct Cooler_f446f3c484ae048c4ba11ef7b8642420_PositionedObject_7643438469673120224 : ICoherenceComponentData
    {
        ...
        {
            var other = (Cooler_f446f3c484ae048c4ba11ef7b8642420_PositionedObject_7643438469673120224)data;
        ...
        public static uint Serialize(Cooler_f446f3c484ae048c4ba11ef7b8642420_PositionedObject_7643438469673120224 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (Cooler_f446f3c484ae048c4ba11ef7b8642420_PositionedObject_7643438469673120224, uint) Deserialize(InProtocolBitStream bitStream)
        {
            ...
            var mask = (uint)0;
            var val = new Cooler_f446f3c484ae048c4ba11ef7b8642420_PositionedObject_7643438469673120224();
            if (bitStream.ReadMask())
            {
        ...
        {
            var last = lastSent as Cooler_f446f3c484ae048c4ba11ef7b8642420_PositionedObject_7643438469673120224?;
            
        }

        public override string ToString()
        {
            return $"Cooler_f446f3c484ae048c4ba11ef7b8642420_PositionedObject_7643438469673120224(objectAnchorSync: { objectAnchorSync }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
