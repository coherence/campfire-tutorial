...
namespace Coherence.Generated
{
    ...
    public struct Banana_c76bd173fbfcfba44982ec0a19f9c897_PositionedObject_4384992023136877932 : ICoherenceComponentData
    {
        ...
        {
            var other = (Banana_c76bd173fbfcfba44982ec0a19f9c897_PositionedObject_4384992023136877932)data;
        ...
        public static uint Serialize(Banana_c76bd173fbfcfba44982ec0a19f9c897_PositionedObject_4384992023136877932 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (Banana_c76bd173fbfcfba44982ec0a19f9c897_PositionedObject_4384992023136877932, uint) Deserialize(InProtocolBitStream bitStream)
        {
            ...
            var mask = (uint)0;
            var val = new Banana_c76bd173fbfcfba44982ec0a19f9c897_PositionedObject_4384992023136877932();
            if (bitStream.ReadMask())
            {
        ...
        {
            var last = lastSent as Banana_c76bd173fbfcfba44982ec0a19f9c897_PositionedObject_4384992023136877932?;
            
        }

        public override string ToString()
        {
            return $"Banana_c76bd173fbfcfba44982ec0a19f9c897_PositionedObject_4384992023136877932(objectAnchorSync: { objectAnchorSync }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
