...
namespace Coherence.Generated
{
    ...
    public struct _8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190.objectAnchorSyncMask;
            objectAnchorSyncSimulationFrame = frame;
        }

        public static unsafe _8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 4) {
            ...
            var orig = new _8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190();
        ...
        {
            var other = (_8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190)data;
        ...
        public static uint Serialize(_8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190();
            if (bitStream.ReadMask())
            {

                val.objectAnchorSync = bitStream.ReadEntity();
                val.FieldsMask |= _8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190.objectAnchorSyncMask;
            }
        ...
        {
            return $"_8833df0ce8b904a2c930b33acfa5fd13_4956315802915571190(" +
