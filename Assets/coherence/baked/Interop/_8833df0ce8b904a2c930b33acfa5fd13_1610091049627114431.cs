...
namespace Coherence.Generated
{
    ...
    public struct _8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431.pathMask;
            pathSimulationFrame = frame;
            FieldsMask |= _8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431.pathDirtyCounterMask;
            pathDirtyCounterSimulationFrame = frame;
        }

        public static unsafe _8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 20) {
            ...
            var orig = new _8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431();
        ...
        {
            var other = (_8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431)data;
        ...
        public static uint Serialize(_8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
            ...
            if (bitStream.WriteMask((mask & 0x01) != 0))
            {
                Coherence.Utils.Bounds.Check(data.pathDirtyCounter, _pathDirtyCounter_Min, _pathDirtyCounter_Max, "_8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431.pathDirtyCounter", logger);
        ...
        public static _8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431();
            if (bitStream.ReadMask())
            {

                val.path = bitStream.ReadShortString();
                val.FieldsMask |= _8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431.pathMask;
            }
            if (bitStream.ReadMask())
            {

                val.pathDirtyCounter = bitStream.ReadIntegerRange(32, -2147483648);
                val.FieldsMask |= _8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431.pathDirtyCounterMask;
            }
        ...
        {
            return $"_8833df0ce8b904a2c930b33acfa5fd13_1610091049627114431(" +
                $" path: { this.path }" +
