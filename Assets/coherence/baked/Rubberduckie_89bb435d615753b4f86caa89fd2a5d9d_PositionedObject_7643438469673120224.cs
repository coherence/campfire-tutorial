...
namespace Coherence.Generated
{
    ...
    public struct Rubberduckie_89bb435d615753b4f86caa89fd2a5d9d_PositionedObject_7643438469673120224 : ICoherenceComponentData
    {
        ...
        {
            var other = (Rubberduckie_89bb435d615753b4f86caa89fd2a5d9d_PositionedObject_7643438469673120224)data;
        ...
        public static uint Serialize(Rubberduckie_89bb435d615753b4f86caa89fd2a5d9d_PositionedObject_7643438469673120224 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (Rubberduckie_89bb435d615753b4f86caa89fd2a5d9d_PositionedObject_7643438469673120224, uint) Deserialize(InProtocolBitStream bitStream)
        {
            ...
            var mask = (uint)0;
            var val = new Rubberduckie_89bb435d615753b4f86caa89fd2a5d9d_PositionedObject_7643438469673120224();
            if (bitStream.ReadMask())
            {
        ...
        {
            var last = lastSent as Rubberduckie_89bb435d615753b4f86caa89fd2a5d9d_PositionedObject_7643438469673120224?;
            
        }

        public override string ToString()
        {
            return $"Rubberduckie_89bb435d615753b4f86caa89fd2a5d9d_PositionedObject_7643438469673120224(objectAnchorSync: { objectAnchorSync }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
