...
namespace Coherence.Generated
{
    ...
    public struct Cupcake_0d27e1ad6d8e5ba4abca3216a92298f7_PositionedObject_4384992023136877932 : ICoherenceComponentData
    {
        ...
        {
            var other = (Cupcake_0d27e1ad6d8e5ba4abca3216a92298f7_PositionedObject_4384992023136877932)data;
        ...
        public static uint Serialize(Cupcake_0d27e1ad6d8e5ba4abca3216a92298f7_PositionedObject_4384992023136877932 data, uint mask, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static (Cupcake_0d27e1ad6d8e5ba4abca3216a92298f7_PositionedObject_4384992023136877932, uint) Deserialize(InProtocolBitStream bitStream)
        {
            ...
            var mask = (uint)0;
            var val = new Cupcake_0d27e1ad6d8e5ba4abca3216a92298f7_PositionedObject_4384992023136877932();
            if (bitStream.ReadMask())
            {
        ...
        {
            var last = lastSent as Cupcake_0d27e1ad6d8e5ba4abca3216a92298f7_PositionedObject_4384992023136877932?;
            
        }

        public override string ToString()
        {
            return $"Cupcake_0d27e1ad6d8e5ba4abca3216a92298f7_PositionedObject_4384992023136877932(objectAnchorSync: { objectAnchorSync }, Mask: {System.Convert.ToString(FieldsMask, 2).PadLeft(1, '0')}), Stopped: {System.Convert.ToString(StoppedMask, 2).PadLeft(1, '0')})";
        }
    }
